...
extern void F1019_7933(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1019_7934(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1019_7935(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1019_7936(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1019_7937(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1019_7938(EIF_REFERENCE);
...
/* {PAIR}.make */
void F1019_7933 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 1018, Current, 0, 2, 14562);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1018, Current, 14562);
	RTCC(arg1, 1018, l_feature_name, 1, RTWCT(5619, dtype, Dftype(Current)), 0x00);
	RTCC(arg2, 1018, l_feature_name, 2, RTWCT(5620, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_REFERENCE *)(Current + RTWA(5614, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5615, 0xF8000000, 0); /* second */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F1019_7934 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1018, Current, 2, 1, 14563);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1018, Current, 14563);
	{
...
body:;
	...
	ur2 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5616, dtype))(Current, ur1x, ur2x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
/* {PAIR}.as_tuple */
EIF_TYPED_VALUE F1019_7935 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1018, Current, 0, 0, 14564);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1018, Current, 14564);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1018, Current, 0, 1, 14557);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1018, Current, 14557);
...
body:;
	...
	if (RTEQ(tr1, tr2)) {
		...
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5615, "second", arg1))(arg1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		tb1 = RTEQ(tr1, tr2);
	}
...
/* {PAIR}.debug_output */
EIF_TYPED_VALUE F1019_7937 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1018, Current, 0, 0, 14558);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1018, Current, 14558);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {PAIR}.out */
EIF_TYPED_VALUE F1019_7938 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1018, Current, 2, 0, 14559);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1018, Current, 14559);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E8, 0,0); /* Result */
