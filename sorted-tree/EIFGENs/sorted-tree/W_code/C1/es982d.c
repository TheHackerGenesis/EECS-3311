...
static const EIF_TYPE_INDEX egt_17_982 [] = {0xFF01,256,0xFF01,0xFFF9,0,186,0xFFFF};
...
static const struct desc_info desc_982[] = {
	...
	{EIF_GENERIC(egt_13_982), 1317, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_14_982), 13727, 0},
	{EIF_GENERIC(egt_15_982), 13728, 8},
	{EIF_GENERIC(egt_16_982), 13729, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13730, 36},
	{EIF_GENERIC(egt_17_982), 13731, 24},
};
void Init982(void)
{
	IDSC(desc_982, 0, 981);
	IDSC(desc_982 + 1, 1, 981);
	IDSC(desc_982 + 32, 193, 981);
	IDSC(desc_982 + 65, 232, 981);
	IDSC(desc_982 + 66, 104, 981);
	IDSC(desc_982 + 91, 372, 981);
}
