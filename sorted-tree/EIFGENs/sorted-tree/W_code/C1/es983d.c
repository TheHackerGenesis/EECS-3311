...
static const struct desc_info desc_983[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 13725, 40},
	{EIF_NON_GENERIC(0x0197 /*203*/), 13726, 41},
	{EIF_GENERIC(egt_14_983), 13727, 0},
	{EIF_GENERIC(egt_15_983), 13728, 8},
	{EIF_GENERIC(egt_16_983), 13729, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13730, 44},
	{EIF_GENERIC(egt_17_983), 13731, 24},
	{EIF_GENERIC(NULL), 13733, 0xFFFFFFFF},
	{EIF_GENERIC(egt_18_983), 13736, 32},
};
void Init983(void)
{
	IDSC(desc_983, 0, 982);
	...
	IDSC(desc_983 + 91, 372, 982);
	IDSC(desc_983 + 103, 374, 982);
}
