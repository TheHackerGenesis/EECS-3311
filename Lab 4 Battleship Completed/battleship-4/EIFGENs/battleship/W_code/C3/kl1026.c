...
extern EIF_TYPED_VALUE F1026_8794(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1026_8794 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1025, Current, 0, 1, 15097);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1025, Current, 15097);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1025, Current, 0, 1, 15098);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1025, Current, 15098);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1025, Current, 0, 1, 15099);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1025, Current, 15099);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_CHARACTER_8 *)tr1 = arg1;
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4107, "next", tr1))(tr1)).it_c1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1025, Current, 0, 1, 15100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1025, Current, 15100);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("c_small_enough", EX_PRE);
...
body:;
	...
	tr1 = RTLN(eif_new_type(194, 0x00).id);
	*(EIF_CHARACTER_8 *)tr1 = arg1;
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4108, "previous", tr1))(tr1)).it_c1);
	Result = (EIF_CHARACTER_8) tc1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("definition", EX_POST);
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1025, Current, 0, 1, 15101);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1025, Current, 15101);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x08000000, 1,0); /* Result */
...
#define arg1 arg1x.it_c1
	...
	RTEAA(l_feature_name, 1025, Current, 0, 1, 15102);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1025, Current, 15102);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x08000000, 1,0); /* Result */
