...
extern EIF_TYPED_VALUE F1025_8793(EIF_REFERENCE);
...
RTOID (F1025_8793)
EIF_TYPED_VALUE F1025_8793 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1024, Current, 0, 0, 15096);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1024, Current, 15096);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
