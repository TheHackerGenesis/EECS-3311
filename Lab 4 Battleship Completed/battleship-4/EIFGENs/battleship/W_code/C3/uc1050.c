...
extern EIF_TYPED_VALUE F1050_9111(EIF_REFERENCE);
...
RTOID (F1050_9111)
EIF_TYPED_VALUE F1050_9111 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1049, Current, 0, 0, 15394);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1049, Current, 15394);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
