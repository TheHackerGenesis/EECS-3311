...
static EIF_TYPED_VALUE F1371_13153_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1371_13153(EIF_REFERENCE);
extern void F1371_16514(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1371_13153_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1370, Current, 0, 0, 19780);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1370, Current, 19780);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1371_13153 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9361, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1371_13153_body (Current)).it_r;
...
void F1371_16514 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1370, Current, 0, 16513);
	RTSA(dtype);
	RTME(dtype, 0);
