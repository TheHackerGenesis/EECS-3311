...
static EIF_TYPED_VALUE F1357_12681_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1357_12681(EIF_REFERENCE);
extern void F1357_16508(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1357_12681_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1356, Current, 0, 0, 19358);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1356, Current, 19358);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1357_12681 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9361, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1357_12681_body (Current)).it_r;
...
void F1357_16508 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1356, Current, 0, 16507);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("not_has_text_implies_text_empty", Current);
	tb1 = '\01';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9660, dtype))(Current)).it_b);
	if ((EIF_BOOLEAN) !tb2) {
