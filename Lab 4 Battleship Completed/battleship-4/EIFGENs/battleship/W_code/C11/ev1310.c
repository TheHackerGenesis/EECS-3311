...
extern EIF_TYPED_VALUE F1310_12027(EIF_REFERENCE);
extern void F1310_12028(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1310_12027 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1310_12028 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1309, Current, 0, 0, 18834);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1309, Current, 18834);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8429, 0xF80005C3, 0); /* implementation */
