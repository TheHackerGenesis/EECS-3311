...
static const EIF_TYPE_INDEX egt_14_1100 [] = {0xFF01,340,0xFF01,1090,0xFFFF};
...
static const struct desc_info desc_1100[] = {
	...
	{EIF_GENERIC(egt_9_1100), 15737, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1100), 15709, 0},
	{EIF_GENERIC(NULL), 15710, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 15735, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1100), 15736, 8},
};
void Init1100(void)
{
	IDSC(desc_1100, 0, 1099);
	IDSC(desc_1100 + 1, 1, 1099);
	IDSC(desc_1100 + 32, 397, 1099);
	IDSC(desc_1100 + 34, 395, 1099);
}
