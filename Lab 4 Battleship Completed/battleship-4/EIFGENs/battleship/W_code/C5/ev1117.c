...
extern EIF_TYPED_VALUE F1117_9835(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1117_9835 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1116, Current, 0, 0, 16074);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1116, Current, 16074);
	RTIV(Current, RTAL);
