...
extern EIF_TYPED_VALUE F1398_13308(EIF_REFERENCE);
extern void F1398_16516(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1398_13308 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(10180,Dtype(Current)));
	return r;
}


/* {EV_FILE_DIALOG_I}._invariant */
void F1398_16516 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1397, Current, 0, 16515);
	RTSA(dtype);
	RTME(dtype, 0);
