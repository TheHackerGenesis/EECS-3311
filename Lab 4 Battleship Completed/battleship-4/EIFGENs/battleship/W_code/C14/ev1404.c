...
extern void F1404_13366(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1404_13367(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1404_13368(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1404_13369(EIF_REFERENCE);
extern void F1404_13370(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1404_13371_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1404_13371(EIF_REFERENCE);
extern void EIF_Minit1404(void);
extern EIF_REFERENCE _A1204_335();
extern EIF_REFERENCE _A1204_334();
...
void F1404_13366 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1403, Current, 0, 1, 19930);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19930);
	RTCC(arg1, 1403, l_feature_name, 1, RTWCT(9361, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1404_13367 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1403, Current, 3, 0, 19931);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19931);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1204_334, (EIF_POINTER)(0),8217, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1204_335, (EIF_POINTER)(0),8218, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(9883, dtype))(Current, up1x, ur1x, ur2x, ur3x);
...
EIF_TYPED_VALUE F1404_13368 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1403, Current, 2, 0, 19932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19932);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
...
EIF_TYPED_VALUE F1404_13369 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(10207,Dtype(Current)));
	return r;
}


/* {EV_DIRECTORY_DIALOG_IMP}.set_start_path */
void F1404_13370 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1403, Current, 1, 1, 19934);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19934);
	RTCC(arg1, 1403, l_feature_name, 1, eif_new_type(185, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10207, 0xF80000B9, 0); /* start_path */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(10207, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
...
static EIF_TYPED_VALUE F1404_13371_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1403, Current, 0, 0, 19935);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1403, Current, 19935);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1404_13371 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9361, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1404_13371_body (Current)).it_r;
