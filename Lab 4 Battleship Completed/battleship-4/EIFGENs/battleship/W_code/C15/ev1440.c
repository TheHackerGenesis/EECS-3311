...
extern void F1440_13956(EIF_REFERENCE);
static EIF_TYPED_VALUE F1440_13960_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1440_13960(EIF_REFERENCE);
...
/* {EV_TREE_I}.make */
void F1440_13956 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1439, Current, 0, 0, 20408);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1439, Current, 20408);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1440_13960_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1439, Current, 0, 0, 20409);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1439, Current, 20409);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1440_13960 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9361, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1440_13960_body (Current)).it_r;
