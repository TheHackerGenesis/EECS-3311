...
extern void F1421_13665(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1421_13666(EIF_REFERENCE);
static EIF_TYPED_VALUE F1421_13667_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1421_13667(EIF_REFERENCE);
...
/* {EV_HORIZONTAL_BOX_IMP}.old_make */
void F1421_13665 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1420, Current, 0, 1, 20171);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1420, Current, 20171);
	RTCC(arg1, 1420, l_feature_name, 1, RTWCT(9361, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1421_13666 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1420, Current, 0, 0, 20172);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1420, Current, 20172);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1421_13667_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1420, Current, 0, 0, 20173);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1420, Current, 20173);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1421_13667 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9361, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1421_13667_body (Current)).it_r;
