...
static const EIF_TYPE_INDEX egt_13_1230 [] = {0xFF01,1020,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1230 [] = {0xFF01,1151,0xFFFF};
...
static const struct desc_info desc_1230[] = {
	...
	{EIF_GENERIC(egt_14_1230), 17695, 0xFFFFFFFF},
};
void Init1230(void)
{
	IDSC(desc_1230, 0, 1229);
	IDSC(desc_1230 + 1, 1, 1229);
	IDSC(desc_1230 + 32, 616, 1229);
}
