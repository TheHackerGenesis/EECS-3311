...
extern void F1463_14325(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1463_14326(EIF_REFERENCE);
static EIF_TYPED_VALUE F1463_14327_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1463_14327(EIF_REFERENCE);
...
void F1463_14325 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1462, Current, 0, 1, 20656);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1462, Current, 20656);
	RTCC(arg1, 1462, l_feature_name, 1, RTWCT(9361, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1463_14326 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1462, Current, 1, 0, 20657);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1462, Current, 20657);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5413, 969))(Current)).it_p);
	RTHOOK(3);
	up1 = loc1;
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9356, 1461))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1463_14327_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1462, Current, 0, 0, 20658);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1462, Current, 20658);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1463_14327 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9361, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1463_14327_body (Current)).it_r;
