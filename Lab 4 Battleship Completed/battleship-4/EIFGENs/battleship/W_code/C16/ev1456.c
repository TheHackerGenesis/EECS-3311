...
extern void F1456_14145(EIF_REFERENCE);
static EIF_TYPED_VALUE F1456_14146_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1456_14146(EIF_REFERENCE);
extern void F1456_14147(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1456_14148(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1456_14149(EIF_REFERENCE);
extern void F1456_14150(EIF_REFERENCE);
extern void F1456_14151(EIF_REFERENCE);
extern void F1456_14152(EIF_REFERENCE);
extern void F1456_14153(EIF_REFERENCE);
extern void F1456_14154(EIF_REFERENCE);
...
void F1456_14145 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1455, Current, 0, 0, 20476);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1455, Current, 20476);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1456_14146_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1455, Current, 0, 0, 20477);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1455, Current, 20477);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1456_14146 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9361, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1456_14146_body (Current)).it_r;
...
void F1456_14147 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 1455, Current, 0, 1, 20478);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1455, Current, 20478);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1456_14148 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1455, Current, 0, 0, 20479);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1455, Current, 20479);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10130, Dtype(Current)))(Current)).it_p);
	up1 = tp1;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5138, 969))(Current, up1x)).it_i4);
...
EIF_TYPED_VALUE F1456_14149 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1456_14150 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1455, Current, 0, 0, 20481);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1455, Current, 20481);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9872, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F1456_14151 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1455, Current, 0, 0, 20482);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1455, Current, 20482);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10130, dtype))(Current)).it_p);
	up1 = tp1;
...
void F1456_14152 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1455, Current, 0, 0, 20483);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1455, Current, 20483);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10728, 0x04000000, 1); /* is_tabable_from */
	*(EIF_BOOLEAN *)(Current + RTWA(10728, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("is_tabable_from", EX_POST);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(10728, dtype));
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F1456_14153 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1455, Current, 0, 0, 20484);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1455, Current, 20484);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10728, 0x04000000, 1); /* is_tabable_from */
...
void F1456_14154 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1455, Current, 0, 0, 20485);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1455, Current, 20485);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9872, dtype))(Current)).it_b);
	if (tb1) {
