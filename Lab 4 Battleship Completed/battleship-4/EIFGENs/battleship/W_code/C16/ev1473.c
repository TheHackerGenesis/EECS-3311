...
extern EIF_TYPED_VALUE F1473_14601(EIF_REFERENCE);
static EIF_TYPED_VALUE F1473_14604_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1473_14604(EIF_REFERENCE);
...
/* {EV_ITEM_I}.parent */
EIF_TYPED_VALUE F1473_14601 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1472, Current, 1, 0, 20928);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1472, Current, 20928);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		{
			static EIF_TYPE_INDEX typarr0[] = {1571,0xFF01,1305,0xFFFF};
			EIF_TYPE typres0;
...
/* {EV_ITEM_I}.interface */
static EIF_TYPED_VALUE F1473_14604_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1472, Current, 0, 0, 20929);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1472, Current, 20929);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1473_14604 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9361, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1473_14604_body (Current)).it_r;
