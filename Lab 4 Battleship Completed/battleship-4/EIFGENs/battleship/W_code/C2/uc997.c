...
extern EIF_TYPED_VALUE F997_8603(EIF_REFERENCE);
...
RTOID (F997_8603)
EIF_TYPED_VALUE F997_8603 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 996, Current, 0, 0, 14930);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(996, Current, 14930);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
