...
static const EIF_TYPE_INDEX egt_13_994 [] = {0xFF01,1151,0xFFFF};
static const EIF_TYPE_INDEX egt_14_994 [] = {0xFF01,1151,0xFFFF};
...
static const struct desc_info desc_994[] = {
	...
	{EIF_GENERIC(egt_13_994), 14919, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08FF /*1151*/), 14920, 0},
	{EIF_GENERIC(egt_14_994), 14921, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08FF /*1151*/), 14922, 8},
};
void Init994(void)
{
	IDSC(desc_994, 0, 993);
	IDSC(desc_994 + 1, 1, 993);
	IDSC(desc_994 + 32, 955, 993);
}
