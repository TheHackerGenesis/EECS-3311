...
extern EIF_TYPED_VALUE F1011_8722(EIF_REFERENCE);
...
RTOID (F1011_8722)
EIF_TYPED_VALUE F1011_8722 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1010, Current, 0, 0, 15033);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1010, Current, 15033);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
