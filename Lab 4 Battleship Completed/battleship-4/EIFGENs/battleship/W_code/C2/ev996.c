...
extern EIF_TYPED_VALUE F996_8595(EIF_REFERENCE);
static EIF_TYPED_VALUE F996_8596_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F996_8596(EIF_REFERENCE);
...
EIF_TYPED_VALUE F996_8595 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 1, 0, 14925);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6381, 0xF800047F, 0); /* selection_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F996_8596_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F996_8596 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6381,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(6381, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F996_8596_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6381,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
