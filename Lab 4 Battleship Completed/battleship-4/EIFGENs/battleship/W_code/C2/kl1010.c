...
extern EIF_TYPED_VALUE F1010_8721(EIF_REFERENCE);
...
RTOID (F1010_8721)
EIF_TYPED_VALUE F1010_8721 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1009, Current, 0, 0, 15032);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1009, Current, 15032);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
