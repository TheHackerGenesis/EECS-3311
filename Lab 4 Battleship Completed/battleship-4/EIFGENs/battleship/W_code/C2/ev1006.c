...
extern EIF_TYPED_VALUE F1006_8694(EIF_REFERENCE);
static EIF_TYPED_VALUE F1006_8695_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1006_8695(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1006_8694 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1005, Current, 1, 0, 15021);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6481, 0xF800047F, 0); /* change_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1006_8695_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1005, Current, 0, 0, 15022);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1006_8695 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6481,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(6481, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1006_8695_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6481,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
