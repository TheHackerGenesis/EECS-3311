...
extern EIF_TYPED_VALUE F1002_8627(EIF_REFERENCE);
...
RTOID (F1002_8627)
EIF_TYPED_VALUE F1002_8627 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1001, Current, 0, 0, 14954);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1001, Current, 14954);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
