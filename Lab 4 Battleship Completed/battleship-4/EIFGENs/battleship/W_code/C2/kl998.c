...
extern EIF_TYPED_VALUE F998_8604(EIF_REFERENCE);
extern EIF_TYPED_VALUE F998_8605(EIF_REFERENCE);
...
RTOID (F998_8604)
EIF_TYPED_VALUE F998_8604 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 14931);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14931);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F998_8605)
EIF_TYPED_VALUE F998_8605 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 14932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14932);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (8604,F998_8604)
	RTOTS (8605,F998_8605)
}
