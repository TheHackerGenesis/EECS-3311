/*
 * Code for class ETF_DEBUG_TEST_INTERFACE
 */
...
extern void F1175_10394(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1175_10395(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1175(void);
extern EIF_REFERENCE _A1175_71_2();
...
/* {ETF_DEBUG_TEST_INTERFACE}.make */
void F1175_10394 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1174, Current, 1, 3, 17080);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1174, Current, 17080);
	...
	RTCC(arg3, 1174, l_feature_name, 3, eif_new_type(1038, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,263,0xFF01,0xFFF9,1,186,197,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1175_71_2, (EIF_POINTER)(0),7943, tr2, 0, 1, -1, tr1, 1);
	}
	tr1 = RTCCL(tr4);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7929, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTHOOK(4);
	ui4_1 = ((EIF_INTEGER_32) 1L);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2672, "item", arg2))(arg2, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	tr1 = RTCCL(tr2);
	RTOB(*(EIF_INTEGER_64 *), eif_new_type(197, 0x00), tr1, loc1, tb1);
	if (tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 7937, 0xF80000E8, 0); /* out */
		tr1 = RTMS_EX_H("debug_test(",11,438599208);
		tr2 = RTMS_EX_H("debug_test",10,723132276);
		ur1 = tr2;
		tr3 = RTMS_EX_H("level",5,1703087468);
		ur2 = tr3;
		ur3 = RTLN(eif_new_type(197, 0x00).id);
...
/* {ETF_DEBUG_TEST_INTERFACE}.debug_test_precond */
EIF_TYPED_VALUE F1175_10395 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
	char *l_feature_name = "debug_test_precond";
	RTEX;
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 1174, Current, 0, 1, 17081);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1174, Current, 17081);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	ui8_1 = arg1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7153, dtype))(Current, ui8_1x)).it_b);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("Result = is_level(level)", EX_POST);
		ui8_1 = arg1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7153, dtype))(Current, ui8_1x)).it_b);
