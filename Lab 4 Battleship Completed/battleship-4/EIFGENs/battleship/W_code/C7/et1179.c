/*
 * Code for class ETF_FIRE_INTERFACE
 */
...
extern void F1179_10402(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1179_10403(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1179(void);
extern EIF_REFERENCE _A1179_71_2();
...
/* {ETF_FIRE_INTERFACE}.make */
void F1179_10402 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1178, Current, 1, 3, 17086);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1178, Current, 17086);
	RTCC(arg1, 1178, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1178, l_feature_name, 2, typres0, 0x01);
	}
	RTCC(arg3, 1178, l_feature_name, 3, eif_new_type(1038, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,263,0xFF01,0xFFF9,1,186,0xFF01,0xFFF9,2,186,197,197,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1179_71_2, (EIF_POINTER)(0),7947, tr2, 0, 1, -1, tr1, 1);
	}
	tr1 = RTCCL(tr4);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7929, dtype)) = (EIF_REFERENCE) tr1;
	...
	if (EIF_TEST(loc1)) {
		...
		tr1 = RTMS_EX_H("fire(",5,1769888040);
		tr2 = RTMS_EX_H("fire",4,1718186597);
		ur1 = tr2;
		tr3 = RTMS_EX_H("coordinate",10,1779599461);
		ur2 = tr3;
		ur3 = RTCCL(loc1);
...
/* {ETF_FIRE_INTERFACE}.fire_precond */
EIF_TYPED_VALUE F1179_10403 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
	char *l_feature_name = "fire_precond";
	RTEX;
#define arg1 arg1x.it_r
	EIF_TYPED_VALUE ur1x = {{0}, SK_REF};
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1178, Current, 0, 1, 17087);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1178, Current, 17087);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,0xFFF9,2,186,197,197,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		...
		RTCC(arg1, 1178, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	ur1 = RTCCL(arg1);
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7152, dtype))(Current, ur1x)).it_b);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("Result = is_coordinate(coordinate)", EX_POST);
		ur1 = RTCCL(arg1);
