...
extern EIF_TYPED_VALUE F1519_15332(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1519_15332 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1518, Current, 0, 0, 21566);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1518, Current, 21566);
	RTIV(Current, RTAL);
	RTHOOK(1);
