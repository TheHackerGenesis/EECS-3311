...
extern EIF_TYPED_VALUE F1154_10209(EIF_REFERENCE);
...
RTOID (F1154_10209)
EIF_TYPED_VALUE F1154_10209 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1153, Current, 0, 0, 16875);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1153, Current, 16875);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
