...
#define Result RTOTRR
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(8161, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
...
#define Result RTOTRR
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(7832, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
#define Result RTOTRR
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(7834, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
