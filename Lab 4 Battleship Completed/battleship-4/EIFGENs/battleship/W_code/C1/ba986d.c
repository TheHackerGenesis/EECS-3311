/*
 * Class reference BATTLESHIP_ACCESS
 */
...
static const EIF_TYPE_INDEX egt_1_986 [] = {0xFF01,1568,985,0xFFFF};
...
static const EIF_TYPE_INDEX egt_14_986 [] = {0xFF01,983,0xFFFF};
...
static const struct desc_info desc_986[] = {
	...
	{EIF_GENERIC(egt_14_986), 14880, 0xFFFFFFFF},
};
void Init986(void)
{
	IDSC(desc_986, 0, 985);
	IDSC(desc_986 + 1, 1, 985);
	IDSC(desc_986 + 32, 382, 985);
}
