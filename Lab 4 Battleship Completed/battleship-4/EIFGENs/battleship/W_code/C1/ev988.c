...
extern EIF_TYPED_VALUE F988_8559(EIF_REFERENCE);
static EIF_TYPED_VALUE F988_8560_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F988_8560(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 987, Current, 1, 0, 14887);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6343, 0xF800047F, 0); /* select_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(6343, dtype)) = (EIF_REFERENCE) tr1;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
static EIF_TYPED_VALUE F988_8558_body (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 987, Current, 0, 0, 14888);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F988_8558 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6343, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
...
EIF_TYPED_VALUE F988_8559 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 987, Current, 1, 0, 14889);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6345, 0xF800047F, 0); /* deselect_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(6345, dtype)) = (EIF_REFERENCE) tr1;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		RTCT("not_void", EX_POST);
...
static EIF_TYPED_VALUE F988_8560_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 987, Current, 0, 0, 14890);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F988_8560 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6345,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(6345, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F988_8560_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6345,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
