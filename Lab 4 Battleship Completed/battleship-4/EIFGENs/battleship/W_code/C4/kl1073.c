...
extern EIF_TYPED_VALUE F1073_9379(EIF_REFERENCE);
...
RTOID (F1073_9379)
EIF_TYPED_VALUE F1073_9379 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1072, Current, 0, 0, 15626);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1072, Current, 15626);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
