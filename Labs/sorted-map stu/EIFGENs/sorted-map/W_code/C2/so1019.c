...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1018, Current, 1, 1, 13948);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	ur2 = RTCCL(arg1);
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5511, "item", tr5))(tr5, ur2x)).it_i4);
	ui4_1 = ti4_2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5539, Dtype(tr4)))(tr4, ur1x, ui4_1x);
	RTNHOOK(2,1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1018, Current, 1, 2, 13949);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
