...
extern void F984_7488(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F984_7489(EIF_REFERENCE);
extern EIF_TYPED_VALUE F984_7490(EIF_REFERENCE);
extern EIF_TYPED_VALUE F984_7491(EIF_REFERENCE);
...
void F984_7488 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 983, Current, 0, 2, 13737);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5243, 0xF8000354, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F984_7489 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 983, Current, 3, 0, 13738);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(983, Current, 13738);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
...
EIF_TYPED_VALUE F984_7490 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 983, Current, 0, 0, 13739);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(983, Current, 13739);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F984_7491 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
